...
function LoginPage() {
  ...
  // Redux auth state
  const { isAuthenticated, error: authError } = useAuthState();
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm">
            Đăng nhập để tiếp tục mua sắm sách
          </p>
        </div>
        ...
        <div className="bg-[#1a2f27] backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-[#254433]">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="flex items-center justify-between pt-2">
                ...
                render={({ field }) => (
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      type="checkbox"
                      checked={field.value}
                      className="w-4 h-4 bg-[#0f1f1a] border border-[#254433] rounded cursor-pointer 
                        focus:ring-2 focus:ring-[#d4995f] accent-[#d4995f]"
                    />
              ...
              <a
                href="#"
                className="text-sm text-[#d4995f] hover:text-[#e6b87f] transition-colors"
              >
                Quên mật khẩu?
              </a>
            </div>
